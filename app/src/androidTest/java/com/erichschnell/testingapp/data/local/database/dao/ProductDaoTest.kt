...
class ProductDaoTest {
    ...
    @Test
    fun givenEmptyDatabase_whenGetAllProducts_thenEmitsEmprtyList() = runTest {
        val products = dao.getAllProducts().first()
        assertTrue(products.isEmpty())
    }

    @Test
    fun givenAListOfProducts_whenGetAllProducts_thenEmitsTheListOfProducts() = runTest {
    ...
    @Test
    fun givenAListOfProductsId_whenCallGetProductsByIds_thenEmitsTheListOfProducts() = runTest {
    ...
    @Test
    fun givenAProductId_whenCallGetProductById_thenEmitsTheProduct() = runTest {
        val p1 = productEntity { withId("p1-id") }
    ...
    @Test
    fun givenAProductIdInexistent_whenCallGetProductById_thenEmitsNull() = runTest {
    ...
    @Test
    fun givenAListOfProducts_whenCallClearProducts_thenCleanDatabase() = runTest {
        val p1 = productEntity { withId("p1-id") }
        val p2 = productEntity { withId("p2-id") }
        val p3 = productEntity { withId("p3-id") }
        dao.insertProducts(listOf(p1,p2,p3))
    ...
    @Test
    fun givenAListOfProducts_whenCallReplaceAll_thenCleanDatabaseAndInsertsNewProducts() = runTest {
