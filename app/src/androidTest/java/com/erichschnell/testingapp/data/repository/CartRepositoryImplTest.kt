...
class CartRepositoryImplTest {
    ...
    @Test
    fun givenCartItems_whenGetCartItemsIsCalled_thenReturnsListOfCartItems() = runTest {
    ...
    @Test
    fun givenCartItem_whenGetCartItemByIdIsCalled_thenReturnsCorrectCartItem() = runTest {
        cartRepository.addToCart("p1", 1)
    ...
    @Test
    fun givenCartItemNotExistInCart_whenGetCartItemByIdIsCalled_thenReturnsNull() = runTest {
        val cartItem = cartRepository.getCartItemById("p1")
        assertNull(cartItem)
    }

    @Test
    fun givenProductIdNotExistInCart_whenAddToCartIsCalled_thenCartItemIsAddedToCart() = runTest {
        cartRepository.addToCart("p1", 1)
        val cartItems = cartRepository.getCartItems().first()
        assertTrue(cartItems.size == 1)
    ...
    @Test
    fun givenProductIdExistInCartAndQuantity_whenAddToCartIsCalled_thenCartItemIsUpdated() = runTest {
        cartRepository.addToCart("p1", 1)
    ...
    @Test
    fun givenProductIdExistInCart_whenRemoveCartItemIsCalled_thenCartItemIsRemoved() = runTest {
        cartRepository.addToCart("p1", 1)
    ...
    fun givenProductIdNotExistInCart_whenRemoveCartItemIsCalled_thenThrowsNotFoundError() = runTest {
        cartRepository.removeCartItem("p1")
    }

    @Test
    fun givenProductIdExistInCart_whenUpdateQuantityIsCalled_thenCartItemIsUpdated() = runTest {
        cartRepository.addToCart("p1", 1)
    ...
    @Test(expected = AppError.NotFoundError::class)
    fun givenProductIdNotExistInCart_whenUpdateQuantityIsCalled_thenThrowsNotFoundError() = runTest {
        cartRepository.updateQuantity("p1",2)
    }

    @Test
    fun givenCartItems_whenClearCartIsCalled_thenCartIsEmpty() = runTest {
        cartRepository.addToCart("p1", 1)
