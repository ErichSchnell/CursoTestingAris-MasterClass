...
class ProductRepositoryImplTest {
    ...
    @Test
    fun givenEmptyProductJson_whenRefreshIsCalled_thenGetProductsEmitsEmptyList() =
        runTest {
    ...
    @Test
    fun givenProductJson_whenRefreshAndGetProductById_thenReturnsCorrectProduct() =
        runTest {
            mockWebServer.server.enqueue(MockResponse().setBody(productJson).setResponseCode(200))
