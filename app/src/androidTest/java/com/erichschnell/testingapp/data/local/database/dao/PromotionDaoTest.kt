...
class PromotionDaoTest {
    ...
    @Test
    fun givenAListOfPromotions_whenGetAllPromotions_thenEmitsTheList() =
        runTest {
    ...
    @Test
    fun givenAListOfPromotions_whenClearPromotions_thenCleanDatabase() =
        runTest {
    ...
    @Test
    fun givenAListOfPromotions_whenReplaceAll_thenCleanDatabaseAndInsertsNewPromotions() =
        runTest {
            val oldPromo1 =
                promotionEntity {
                    withId("old-promo-1")
                    withType(PromotionType.PERCENT.name)
                }
            ...
            val newPromo1 =
                promotionEntity {
                    withId("new-promo-1")
                    withType(PromotionType.BUY_X_PAY_Y.name)
                }
            val newPromo2 =
                promotionEntity {
                    withId("new-promo-2")
    ...
    @Test
    fun givenAListOfPromotionsExistent_whenInsertPromotions_thenUpdateAllPromotionsExistentAndInsertNewPromotions() =
        runTest {
            val oldPromo1 =
                promotionEntity {
                    withId("old-promo-1")
