...
class RemoteDataSourceTest {
    ...
    @Test
    fun `given 404 response when getProducts then restunrs NotFoundError`() = runTest {
    ...
    @Test
    fun `given malformed json when getProducts then restunrs UnknownError`() = runTest {
