...
class UpdateCartItemUseCaseTest {
    @Test
    fun `given negative quantity when invoke then throw QuantityMustBePositive`() =
        runTest {
            // Given
    ...
    @Test
    fun `given zero quantity when invoke then remove item from cart`() =
        runTest {
            // Given
    ...
    @Test
    fun `given productById null when invoke then return NotFoundError`() =
        runTest {
            // Given
            val product =
                product {
    ...
    @Test
    fun `given update successful when invoke then cart is updated`() =
        runTest {
            // Given
            val product =
                product {
